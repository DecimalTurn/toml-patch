/**
 * Integration tests for TomlDocument backward compatibility
 * 
 * Tests that TomlDocument.patch() works with various object creation patterns
 * without requiring TomlFormat imports, ensuring backward compatibility.
 */

const { TomlDocument, TomlFormat } = require("../../../dist/toml-patch.cjs.min.js");

describe('TomlDocument Backward Compatibility Integration', () => {
