/**
 * Smoke test: @js-temporal/polyfill (comprehensive Temporal API probe).
 *
 * Probes the full Temporal API surface via the polyfill. The polyfill
 * provides a complete Temporal implementation across all Node versions.
 *
...
test('Duration.years', () => { if(dur.years !== 1) throw new Error('wrong'); });
test('Duration.months', () => { if(dur.months !== 2) throw new Error('wrong'); });
test('Duration.weeks', () => { if(dur.weeks !== 3) throw new Error('wrong'); });
test('Duration.days', () => { if(dur.days !== 4) throw new Error('wrong'); });
test('Duration.hours', () => { if(dur.hours !== 5) throw new Error('wrong'); });
test('Duration.minutes', () => { if(dur.minutes !== 6) throw new Error('wrong'); });
test('Duration.seconds', () => { if(dur.seconds !== 7) throw new Error('wrong'); });
test('Duration.milliseconds', () => { if(dur.milliseconds !== 8) throw new Error('wrong'); });
test('Duration.microseconds', () => { if(dur.microseconds !== 9) throw new Error('wrong'); });
test('Duration.nanoseconds', () => { if(dur.nanoseconds !== 0) throw new Error('wrong'); });
test('Duration.sign', () => { if(dur.sign !== 1) throw new Error('wrong'); });
test('Duration.blank', () => { if(new Temporal.Duration().blank !== true) throw new Error('wrong'); });
...
test('Duration.valueOf throws', () => {
  try { dur.valueOf(); throw new Error('should throw'); }
...
test('Instant.epochMilliseconds', () => { if(typeof inst.epochMilliseconds !== 'number') throw new Error('wrong'); });
test('Instant.epochNanoseconds', () => { if(typeof inst.epochNanoseconds !== 'bigint') throw new Error('wrong'); });
...
test('Instant.valueOf throws', () => {
  try { inst.valueOf(); throw new Error('should throw'); }
  catch(e) { if(e.message === 'should throw') throw e; }
});
...
test('PlainDate.year', () => { if(pd.year !== 2024) throw new Error('wrong'); });
test('PlainDate.month', () => { if(pd.month !== 1) throw new Error('wrong'); });
test('PlainDate.day', () => { if(pd.day !== 15) throw new Error('wrong'); });
test('PlainDate.dayOfWeek', () => { if(typeof pd.dayOfWeek !== 'number') throw new Error('wrong'); });
test('PlainDate.dayOfYear', () => { if(typeof pd.dayOfYear !== 'number') throw new Error('wrong'); });
test('PlainDate.weekOfYear', () => { if(typeof pd.weekOfYear !== 'number') throw new Error('wrong'); });
test('PlainDate.daysInWeek', () => { if(pd.daysInWeek !== 7) throw new Error('wrong'); });
test('PlainDate.daysInMonth', () => { if(typeof pd.daysInMonth !== 'number') throw new Error('wrong'); });
test('PlainDate.daysInYear', () => { if(typeof pd.daysInYear !== 'number') throw new Error('wrong'); });
test('PlainDate.monthsInYear', () => { if(pd.monthsInYear !== 12) throw new Error('wrong'); });
test('PlainDate.inLeapYear', () => { if(typeof pd.inLeapYear !== 'boolean') throw new Error('wrong'); });
...
test('PlainDate.valueOf throws', () => {
  try { pd.valueOf(); throw new Error('should throw'); }
  catch(e) { if(e.message === 'should throw') throw e; }
});
...
test('PlainTime.hour', () => { if(pt.hour !== 12) throw new Error('wrong'); });
test('PlainTime.minute', () => { if(pt.minute !== 30) throw new Error('wrong'); });
test('PlainTime.second', () => { if(pt.second !== 45) throw new Error('wrong'); });
test('PlainTime.millisecond', () => { if(pt.millisecond !== 123) throw new Error('wrong'); });
test('PlainTime.microsecond', () => { if(pt.microsecond !== 456) throw new Error('wrong'); });
test('PlainTime.nanosecond', () => { if(pt.nanosecond !== 789) throw new Error('wrong'); });
...
test('PlainTime.valueOf throws', () => {
  try { pt.valueOf(); throw new Error('should throw'); }
  catch(e) { if(e.message === 'should throw') throw e; }
});
...
test('PlainDateTime.year', () => { if(pdt.year !== 2024) throw new Error('wrong'); });
test('PlainDateTime.month', () => { if(pdt.month !== 1) throw new Error('wrong'); });
test('PlainDateTime.day', () => { if(pdt.day !== 15) throw new Error('wrong'); });
test('PlainDateTime.hour', () => { if(pdt.hour !== 12) throw new Error('wrong'); });
test('PlainDateTime.minute', () => { if(pdt.minute !== 30) throw new Error('wrong'); });
test('PlainDateTime.second', () => { if(pdt.second !== 45) throw new Error('wrong'); });
...
test('PlainDateTime.valueOf throws', () => {
  try { pdt.valueOf(); throw new Error('should throw'); }
  catch(e) { if(e.message === 'should throw') throw e; }
});
...
test('ZonedDateTime.year', () => { if(zdt.year !== 2024) throw new Error('wrong'); });
test('ZonedDateTime.month', () => { if(zdt.month !== 1) throw new Error('wrong'); });
test('ZonedDateTime.day', () => { if(zdt.day !== 15) throw new Error('wrong'); });
test('ZonedDateTime.hour', () => { if(zdt.hour !== 12) throw new Error('wrong'); });
test('ZonedDateTime.minute', () => { if(zdt.minute !== 30) throw new Error('wrong'); });
test('ZonedDateTime.second', () => { if(zdt.second !== 45) throw new Error('wrong'); });
test('ZonedDateTime.offset', () => { if(typeof zdt.offset !== 'string') throw new Error('wrong'); });
test('ZonedDateTime.offsetNanoseconds', () => { if(typeof zdt.offsetNanoseconds !== 'number') throw new Error('wrong'); });
test('ZonedDateTime.timeZoneId', () => { if(typeof zdt.timeZoneId !== 'string') throw new Error('wrong'); });
...
if (typeof zdt.getTimeZoneTransition === 'function') {
  test('ZonedDateTime.getTimeZoneTransition', () => { zdt.getTimeZoneTransition(Temporal.Instant.from('2024-01-15T12:00:00Z'), { direction: 'next' }); });
}
test('ZonedDateTime.valueOf throws', () => {
  try { zdt.valueOf(); throw new Error('should throw'); }
  catch(e) { if(e.message === 'should throw') throw e; }
});
...
// --- Temporal.PlainYearMonth (polyfill extra) ---
if (typeof Temporal.PlainYearMonth === 'function') {
  const pym = Temporal.PlainYearMonth.from('2024-01');
  test('PlainYearMonth.from', () => { Temporal.PlainYearMonth.from('2024-01'); });
  test('PlainYearMonth.year', () => { if(pym.year !== 2024) throw new Error('wrong'); });
  test('PlainYearMonth.month', () => { if(pym.month !== 1) throw new Error('wrong'); });
  test('PlainYearMonth.daysInMonth', () => { if(typeof pym.daysInMonth !== 'number') throw new Error('wrong'); });
  test('PlainYearMonth.toString', () => { pym.toString(); });
}

// --- Temporal.PlainMonthDay (polyfill extra) ---
if (typeof Temporal.PlainMonthDay === 'function') {
  const pmd = Temporal.PlainMonthDay.from('01-15');
  test('PlainMonthDay.from', () => { Temporal.PlainMonthDay.from('01-15'); });
  test('PlainMonthDay.month', () => { if(typeof pmd.month === 'number' && pmd.month !== 1) throw new Error('wrong: ' + pmd.month); });
  test('PlainMonthDay.day', () => { if(pmd.day !== 15) throw new Error('wrong'); });
